...
/**
 * La clase `Keyboard` representa una parte de la computadora, en este caso, el teclado.
...
public class Keyboard implements ComputerPart {
     ...
     *
     * @param computerPartVisitor El visitante que realizará la operación sobre el `Keyboard`.
     */
    @Override
    public void accept(ComputerPartVisitor computerPartVisitor) {
        computerPartVisitor.visit(this);  // El visitante realiza una acción sobre este teclado.
    }
}
